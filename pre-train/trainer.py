#4-Step : ✅ Summary:
# Trains the model using both recommendation loss and contrastive loss
# Uses Adam optimizer and early stopping (based on HR@10)
# Runs validation every few epochs
# Automatically saves the best model (best.pt) based on performance
# Logs all metrics (Loss, NDCG@k, HR@k) for monitoring
