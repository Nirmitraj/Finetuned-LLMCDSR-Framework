#This folder is responsible for the Collaborative-Textual Contrastive Pre-Training stage, which aligns textual features (from LLMs) with collaborative features (from real user-item interactions), as described in Section 4.3 of the paper

#8-Step : Only run this
...
with open(f'../data/{args.dataset}/item_set_{args.domain}.pkl', 'rb') as f:
