#4_step : Parsed items to embeddings 
...
from get_item_embedding import prepare_model

def get_embedding(text_batch, model):
    return model.encode(text_batch, normalize_embeddings=True, show_progress_bar=False)
