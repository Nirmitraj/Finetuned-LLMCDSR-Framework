# Helper module, it should not be run 

# | Function                     | Purpose                              | Used By                                       |
# | ---------------------------- | ------------------------------------ | --------------------------------------------- |
# | `StopAfterSpaceIsGenerated`  | Controls LLM output length           | `parse_items.py`                              |
# | `sample_by_rank`             | Splits dataset for multi-GPU jobs    | `candidate_generate_icl.py`, `parse_items.py` |
# | `sample_by_subset`           | Prepares A/B data for generation     | `candidate_generate_icl.py`                   |
# | `parse_generated_candidates` | Extracts item names from LLM output  | `get_candidate_embedding.py`                  |
# | `concat_icl`                 | Builds prompts with few-shot context | `candidate_generate_icl.py`                   |
