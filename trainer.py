'''
train_meta_step():	Performs meta-learning with a shadow model to help the pooling model adapt
train():	Main training loop that handles augmentation, meta-updates, evaluation, logging, and early stopping
'''
...
def train(model, rec_dataset, aug_dataset, meta_dataset, evaluators, args, pooling_model):
    ...
    print(f"[DEBUG] aug_dataset size: {len(aug_dataset)}")
