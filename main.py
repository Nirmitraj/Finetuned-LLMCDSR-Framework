'''
→ Parse CLI args (Command-Line Interface arguments)
→ Set up folders and logging
→ Load + partition data (train, validation, test)
→ Load LLM-generated augmentation
→ Load embeddings + projection layers
→ Initialize models (SASRec, Selector)
→ Train with early stopping
→ Evaluate best models (A & B domain)
→ Log and wandb-log metrics
...
if __name__ == '__main__':
    ...
    print(f"DEBUG: Anum = {Anum}, Bnum = {Bnum}")
